...
export default function OnboardingMendbotScreen() {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.topSection}>
            ...
            <View style={styles.centerImageContainer}>
              <Image
                source={require("../../assets/images/mendbot-image.png")}
          ...
          <View style={styles.bottomSection}>
            <Button title="Meet Mendbot" onPress={handleNext} />
          </View>
        </View>
      </SafeAreaView>
    </ImageBackground>
...
const styles = StyleSheet.create({
  background: {
    flex: 1,
    backgroundColor: "#E8F4FD", // Add fallback background color
  },
  container: {
    flex: 1,
